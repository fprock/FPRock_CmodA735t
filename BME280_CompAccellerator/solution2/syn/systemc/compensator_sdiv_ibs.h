...
// ==============================================================
#ifndef __compensator_sdiv_ibs__HH__
#define __compensator_sdiv_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compensator_sdiv_ibs) {
    ...
    SC_CTOR(compensator_sdiv_ibs):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
