...
// ==============================================================
#ifndef __compensator_mul_1hbi__HH__
#define __compensator_mul_1hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compensator_mul_1hbi) {
    ...
    SC_CTOR(compensator_mul_1hbi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
