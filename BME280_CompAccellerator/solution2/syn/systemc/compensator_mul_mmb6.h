...
// ==============================================================
#ifndef __compensator_mul_mmb6__HH__
#define __compensator_mul_mmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compensator_mul_mmb6) {
    ...
    SC_CTOR(compensator_mul_mmb6):  ACMP_smul_us_U ("ACMP_smul_us_U") {
