...
// ==============================================================
#ifndef __compensator_mul_mrcU__HH__
#define __compensator_mul_mrcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compensator_mul_mrcU) {
    ...
    SC_CTOR(compensator_mul_mrcU):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
