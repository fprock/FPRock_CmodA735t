...
// ==============================================================
#ifndef __compensator_mac_mocq__HH__
#define __compensator_mac_mocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(compensator_mac_mocq) {
    ...
    SC_CTOR(compensator_mac_mocq):  simcore_mac_1_U ("simcore_mac_1_U") {
