...
// ==============================================================
#ifndef __compensator_mul_mqcK__HH__
#define __compensator_mul_mqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compensator_mul_mqcK) {
    ...
    SC_CTOR(compensator_mul_mqcK):  ACMP_smul_su_U ("ACMP_smul_su_U") {
