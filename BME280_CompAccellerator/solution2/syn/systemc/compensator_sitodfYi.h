...
// ==============================================================
#ifndef __compensator_sitodfYi__HH__
#define __compensator_sitodfYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(compensator_sitodfYi) {
    ...
    SC_CTOR(compensator_sitodfYi):  ACMP_sitodp_U ("ACMP_sitodp_U") {
