# 1 "hls_src/BME280_Compensation.c"
# 1 "hls_src/BME280_Compensation.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "hls_src/BME280_Compensation.c" 2
# 1 "hls_src/BME280_Compensation.h" 1
...
# 4 "hls_src/BME280_Compensation.h" 2
...
# 5 "hls_src/BME280_Compensation.h" 2
...
# 6 "hls_src/BME280_Compensation.h" 2
...
# 7 "hls_src/BME280_Compensation.h" 2
# 29 "hls_src/BME280_Compensation.h"
...
# 2 "hls_src/BME280_Compensation.c" 2


void compensator(BME280_float *temp_comp, BME280_float *pres_comp, BME280_float *hum_comp,
  BME280_s32 temp_raw, BME280_s32 pres_raw, BME280_s32 hum_raw){
_ssdm_op_SpecResourceLimit(25, "", "DSP_Macro", "", "");
# 5 "hls_src/BME280_Compensation.c"

_ssdm_op_SpecInterface(hum_raw, "s_axilite", 0, 0, "", 0, 0, "compensator_io", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(pres_raw, "s_axilite", 0, 0, "", 0, 0, "compensator_io", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(temp_raw, "s_axilite", 0, 0, "", 0, 0, "compensator_io", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(hum_comp, "s_axilite", 0, 0, "", 0, 0, "compensator_io", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(pres_comp, "s_axilite", 0, 0, "", 0, 0, "compensator_io", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(temp_comp, "s_axilite", 0, 0, "", 0, 0, "compensator_io", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(0, "s_axilite", 0, 0, "", 0, 0, "compensator_io", "", "", 0, 0, 0, 0, "", "");

 const BME280_s16 compensation[18] = {

# 1 "hls_src/BME280_comp_vals_h.dat" 1
0x6E4D,
0x67AE,
0x0032,
0x9043,
...
0x0032,
0x001E
# 16 "hls_src/BME280_Compensation.c" 2
 };
_ssdm_SpecConstant(compensation);
# 14 "hls_src/BME280_Compensation.c"
...
#pragma 
# 25 "hls_src/BME280_Compensation.c"

{ _ssdm_RegionBegin("?DSP_Macro_var1_s32_Region_hls_src/BME280_Compensation.c:25:1");
# 25 "hls_src/BME280_Compensation.c"
var1_s32 = ((((temp_raw>>3) - ((BME280_s32)((BME280_u16)compensation[0])<<1))) * ((BME280_s32)compensation[1])) >> 11;
_ssdm_op_SpecResource(var1_s32, "?DSP_Macro_var1_s32_Region_hls_src/BME280_Compensation.c:25:1", "", "DSP_Macro", "", -1, "", "", "", "", "");
_ssdm_RegionEnd("?DSP_Macro_var1_s32_Region_hls_src/BME280_Compensation.c:25:1"); }
# 25 "hls_src/BME280_Compensation.c"

 
#pragma 
# 26 "hls_src/BME280_Compensation.c"

{ _ssdm_RegionBegin("?DSP_Macro_var2_s32_Region_hls_src/BME280_Compensation.c:26:1");
# 26 "hls_src/BME280_Compensation.c"
var2_s32 = (((((temp_raw>>4) - ((BME280_s32)((BME280_u16)compensation[0]))) * ((temp_raw>>4) - ((BME280_s32)((BME280_u16)compensation[0])))) >> 12) * ((BME280_s32)compensation[2])) >> 14;
_ssdm_op_SpecResource(var2_s32, "?DSP_Macro_var2_s32_Region_hls_src/BME280_Compensation.c:26:1", "", "DSP_Macro", "", -1, "", "", "", "", "");
_ssdm_RegionEnd("?DSP_Macro_var2_s32_Region_hls_src/BME280_Compensation.c:26:1"); }
# 26 "hls_src/BME280_Compensation.c"

 
#pragma 
# 27 "hls_src/BME280_Compensation.c"

{ _ssdm_RegionBegin("?DSP_Macro_t_fine_Region_hls_src/BME280_Compensation.c:27:1");
# 27 "hls_src/BME280_Compensation.c"
t_fine = var1_s32 + var2_s32;
_ssdm_op_SpecResource(t_fine, "?DSP_Macro_t_fine_Region_hls_src/BME280_Compensation.c:27:1", "", "DSP_Macro", "", -1, "", "", "", "", "");
_ssdm_RegionEnd("?DSP_Macro_t_fine_Region_hls_src/BME280_Compensation.c:27:1"); }
# 27 "hls_src/BME280_Compensation.c"

 
#pragma 
# 28 "hls_src/BME280_Compensation.c"

{ _ssdm_RegionBegin("?DSP_Macro_temp_comp_var_Region_hls_src/BME280_Compensation.c:28:1");
# 28 "hls_src/BME280_Compensation.c"
temp_comp_var = (BME280_float)(((t_fine * 5 + 128) >> 8)/100.0);
_ssdm_op_SpecResource(temp_comp_var, "?DSP_Macro_temp_comp_var_Region_hls_src/BME280_Compensation.c:28:1", "", "DSP_Macro", "", -1, "", "", "", "", "");
_ssdm_RegionEnd("?DSP_Macro_temp_comp_var_Region_hls_src/BME280_Compensation.c:28:1"); }
# 28 "hls_src/BME280_Compensation.c"
...
#pragma 
# 31 "hls_src/BME280_Compensation.c"

{ _ssdm_RegionBegin("?DSP_Macro_var1_s64_Region_hls_src/BME280_Compensation.c:31:1");
# 31 "hls_src/BME280_Compensation.c"
var1_s64 = ((BME280_s64)t_fine) - 128000;
_ssdm_op_SpecResource(var1_s64, "?DSP_Macro_var1_s64_Region_hls_src/BME280_Compensation.c:31:1", "", "DSP_Macro", "", -1, "", "", "", "", "");
_ssdm_RegionEnd("?DSP_Macro_var1_s64_Region_hls_src/BME280_Compensation.c:31:1"); }
# 31 "hls_src/BME280_Compensation.c"

 
#pragma 
# 32 "hls_src/BME280_Compensation.c"

{ _ssdm_RegionBegin("?DSP_Macro_var2_s64_Region_hls_src/BME280_Compensation.c:32:1");
# 32 "hls_src/BME280_Compensation.c"
var2_s64 = var1_s64 * var1_s64 * (BME280_s64)compensation[8];
_ssdm_op_SpecResource(var2_s64, "?DSP_Macro_var2_s64_Region_hls_src/BME280_Compensation.c:32:1", "", "DSP_Macro", "", -1, "", "", "", "", "");
_ssdm_RegionEnd("?DSP_Macro_var2_s64_Region_hls_src/BME280_Compensation.c:32:1"); }
# 32 "hls_src/BME280_Compensation.c"

 var2_s64 = var2_s64 + ((var1_s64 * (BME280_s64)compensation[7])<<17);
 var2_s64 = var2_s64 + (((BME280_s64)compensation[6])<<35);
 var1_s64 = ((var1_s64 * var1_s64 * (BME280_s64)compensation[5])>>8) + ((var1_s64 * (BME280_s64)compensation[4])<<12);
 var1_s64 = (((((BME280_s64)1)<<47)+var1_s64))*((BME280_s64)((BME280_u16)compensation[3]))>>33;
 if(var1_s64 == 0){
  
#pragma 
# 38 "hls_src/BME280_Compensation.c"

{ _ssdm_RegionBegin("?DSP_Macro_pres_comp_var_Region_hls_src/BME280_Compensation.c:38:1");
# 38 "hls_src/BME280_Compensation.c"
pres_comp_var = 0.0;
_ssdm_op_SpecResource(pres_comp_var, "?DSP_Macro_pres_comp_var_Region_hls_src/BME280_Compensation.c:38:1", "", "DSP_Macro", "", -1, "", "", "", "", "");
_ssdm_RegionEnd("?DSP_Macro_pres_comp_var_Region_hls_src/BME280_Compensation.c:38:1"); }
# 38 "hls_src/BME280_Compensation.c"
...
#pragma 
# 41 "hls_src/BME280_Compensation.c"

{ _ssdm_RegionBegin("?DSP_Macro_p_fine_Region_hls_src/BME280_Compensation.c:41:1");
# 41 "hls_src/BME280_Compensation.c"
p_fine = 1048576 - pres_raw;
_ssdm_op_SpecResource(p_fine, "?DSP_Macro_p_fine_Region_hls_src/BME280_Compensation.c:41:1", "", "DSP_Macro", "", -1, "", "", "", "", "");
_ssdm_RegionEnd("?DSP_Macro_p_fine_Region_hls_src/BME280_Compensation.c:41:1"); }
# 41 "hls_src/BME280_Compensation.c"

  p_fine = (((p_fine<<31) - var2_s64)*3125)/var1_s64;
  var1_s64 = (((BME280_s64)compensation[11]) * (p_fine>>13) * (p_fine>>13)) >> 25;
  var2_s64 = (((BME280_s64)compensation[10]) * p_fine) >> 19;
  pres_comp_var = (BME280_float)((((p_fine + var1_s64 + var2_s64) >> 8) + (((BME280_s64)compensation[9])<<4))/256.0);
 }


 var1_s32 = (t_fine - ((BME280_s32)76800));
 var1_s32 = (((((hum_raw << 14) - (((BME280_s32)compensation[15]) << 20) - (((BME280_s32)compensation[16]) * var1_s32)) +
 ((BME280_s32)16384)) >> 15) * (((((((var1_s32 * ((BME280_s32)compensation[17])) >> 10) * (((var1_s32 * ((BME280_s32)compensation[14])) >> 11) + ((BME280_s32)32768))) >> 10) + ((BME280_s32)2097152)) *
 ((BME280_s32)compensation[13]) + 8192) >> 14));
 var1_s32 = (var1_s32 - (((((var1_s32 >> 15) * (var1_s32 >> 15)) >> 7) * ((BME280_s32)compensation[12])) >> 4));
 var1_s32 = (var1_s32 < 0 ? 0 : var1_s32);
 var1_s32 = (var1_s32 > 419430400 ? 419430400 : var1_s32);
 
#pragma 
# 56 "hls_src/BME280_Compensation.c"

{ _ssdm_RegionBegin("?DSP_Macro_hum_comp_var_Region_hls_src/BME280_Compensation.c:56:1");
# 56 "hls_src/BME280_Compensation.c"
hum_comp_var = (BME280_float)((var1_s32>>12)/1024.0);
_ssdm_op_SpecResource(hum_comp_var, "?DSP_Macro_hum_comp_var_Region_hls_src/BME280_Compensation.c:56:1", "", "DSP_Macro", "", -1, "", "", "", "", "");
_ssdm_RegionEnd("?DSP_Macro_hum_comp_var_Region_hls_src/BME280_Compensation.c:56:1"); }
# 56 "hls_src/BME280_Compensation.c"
