...
set out_width 27
set exp i0*i1
set arg_lists {i0 {7 0 +} i1 {20 1 +} p {27 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set out_width 30
set exp i0*i1+i2
set arg_lists {i0 {7 1 +} i1 {22 1 +} m {29 1 +} i2 {30 1 +} p {30 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 31
set exp i0*i1+i2
set arg_lists {i0 {10 0 +} i1 {22 0 +} m {31 0 +} i2 {15 0 +} p {31 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set out_width 35
set exp i0*i1
set arg_lists {i0 {13 0 +} i1 {22 1 +} p {35 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set out_width 32
set exp i0*i1
set arg_lists {i0 {17 1 +} i1 {17 0 +} p {32 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set out_width 32
set exp i0*i1
set arg_lists {i0 {8 0 +} i1 {25 1 +} p {32 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 40 \
			corename compensator_compensator_io_axilite \
			name compensator_compensator_io_s_axi \
			ports {$port_compensator_io} \
			op interface \
			is_flushable 0 \ 
		} "
	} else {
		puts "@W \[IMPL-110\] Cannot find AXI Lite interface model in the library. Ignored generation of AXI Lite  interface for 'compensator_io'"
	}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler compensator_compensator_io_s_axi
}
