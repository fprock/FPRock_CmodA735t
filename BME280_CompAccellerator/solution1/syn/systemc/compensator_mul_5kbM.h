...
// ==============================================================
#ifndef __compensator_mul_5kbM__HH__
#define __compensator_mul_5kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compensator_mul_5kbM) {
    ...
    SC_CTOR(compensator_mul_5kbM):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
