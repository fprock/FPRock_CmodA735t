...
// ==============================================================
#ifndef __compensator_mul_1lbW__HH__
#define __compensator_mul_1lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compensator_mul_1lbW) {
    ...
    SC_CTOR(compensator_mul_1lbW):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
