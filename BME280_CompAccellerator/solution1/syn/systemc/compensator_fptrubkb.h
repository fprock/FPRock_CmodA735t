...
// ==============================================================
#ifndef __compensator_fptrubkb__HH__
#define __compensator_fptrubkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(compensator_fptrubkb) {
    ...
    SC_CTOR(compensator_fptrubkb):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
