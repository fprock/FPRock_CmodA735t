...
// ==============================================================
#ifndef __compensator_mul_1g8j__HH__
#define __compensator_mul_1g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compensator_mul_1g8j) {
    ...
    SC_CTOR(compensator_mul_1g8j):  ACMP_mul_us_U ("ACMP_mul_us_U") {
